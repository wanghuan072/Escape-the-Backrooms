...
onMounted(() => {
  ...
  queueGpt((googletag) => {
    ...
    const formats = [
      [GPT_UNITS.home.anchor, googletag.enums.OutOfPageFormat.BOTTOM_ANCHOR],
      [GPT_UNITS.home.anchor, googletag.enums.OutOfPageFormat.LEFT_SIDE_RAIL],
      [GPT_UNITS.home.anchor, googletag.enums.OutOfPageFormat.RIGHT_SIDE_RAIL],
      [GPT_UNITS.home.interstitial, googletag.enums.OutOfPageFormat.INTERSTITIAL],
    ]
