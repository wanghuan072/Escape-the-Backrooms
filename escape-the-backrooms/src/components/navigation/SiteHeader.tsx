  ...
  const searchBox = (mobile = false) => (
    <div className={mobile ? 'mobile-search' : 'header-search'}>
      <div className="search-wrapper">
        ...
        />
        <button className="search-button" onClick={submitSearch} type="button" aria-label="Search">
    ...
    <header className="header">
      <div className="header-container">
        <div className="header-wrap">
          <div className="logo">
            <a href={localizedPath('/', locale)} className="logo-link" aria-label="Escape the Backrooms">
              <img src="/images/logo.webp" alt="" className="logo-image" />
          ...
          <div className="header-actions">
            ...
            <div className="language-switcher" ref={languageRef}>
              <button className="language-button" onClick={() => setLanguageOpen((open) => !open)} aria-label={`Current language: ${currentLanguageName}`} type="button">
