        ...
        <div className="footer-grid">
          <div className="footer-brand">
            <div className="footer-logo">
              <Image src="/images/logo.webp" alt="Escape the Backrooms" className="logo-image" width={70} height={49} sizes="(max-width: 768px) 40px, 60px" />
              <span className="logo-text">ESCAPE THE BACKROOMS</span>
            </div>
            <p className="footer-text">{labels.description}</p>
            <a className="footer-youtube-link" href={siteConfig.social.youtube} target="_blank" rel="noopener noreferrer" aria-label={labels.youtube}>
          ...
          <div className="link-column">
            <h2>{labels.legal}</h2>
            <ul>
              <li><a href={localizedPath('/privacy-policy', locale)}>{labels.privacy}</a></li>
              <li><a href={localizedPath('/terms-of-service', locale)}>{labels.terms}</a></li>
              <li><a href={localizedPath('/copyright', locale)}>{labels.copyright}</a></li>
              <li><a href={localizedPath('/about-us', locale)}>{labels.about}</a></li>
              <li><a href={localizedPath('/contact-us', locale)}>{labels.contact}</a></li>
            </ul>
          </div>
        </div>
