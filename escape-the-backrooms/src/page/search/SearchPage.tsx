...
export default function SearchPage({ locale }: { locale: Locale }) {
  return <Suspense fallback={<SearchFallback locale={locale} />}><SearchClient locale={locale} levels={getLevels(locale)} maps={getMaps(locale)} entities={getEntities()} /></Suspense>
}
