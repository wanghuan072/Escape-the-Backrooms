    ...
    <div className="related-game-detail-view">
      ...
      <section className="article-section"><div className="container article-layout">
        <main className="article-main">
          <section className="media-panel"><div className="media-image"><IntrinsicImage src={game.capsuleImageUrl} alt={game.imageAlt} loading="lazy" sizes="(max-width: 768px) 100vw, 50vw" /></div><div className="media-copy"><span className="section-label">{copy.playerVerdict}</span><h2>{game.fit}</h2><p>{game.summary}</p></div></section>
