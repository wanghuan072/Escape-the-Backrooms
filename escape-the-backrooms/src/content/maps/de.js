export default [
    ...
    { id: 9, title: 'Level 5 Terror Hotel Karten', addressBar: 'level-5-terror-hotel-map', description: 'Karten für alle drei Bereiche von Level 5 Terror Hotel: Main Hall, Hotel und Boiler Room.', imageUrl: '/images/maps/Level_Main_Hall_Map.webp', imageAlt: 'Level-5-Main-Hall-Karte.', mapImageUrl: '/images/maps/Level_Main_Hall_Map.webp', galleryImages: [{ src: '/images/maps/Level_5_Hotel_Map.webp', alt: 'Level-5-Hotel-Karte.', title: 'Das Hotel' }, { src: '/images/maps/Level_5_Boiler_Room_Map.webp', alt: 'Level-5-Boiler-Room-Karte.', title: 'Der Boiler Room' }], category: 'Hauptstory', tags: ['Level 5', 'Main Hall', 'Hotel', 'Boiler Room'], isHome: false, seo: { title: 'Level 5 Terror Hotel Karten: Main Hall, Hotel & Boiler Room - Escape the Backrooms', description: 'Referenzkarten für die drei Bereiche des Level 5 Terror Hotel.', keywords: 'Level 5 Karte, Terror Hotel, Main Hall, Hotel, Boiler Room' }, mapPoints: [{ id: 1, title: 'Main Hall', content: 'Gemälderätsel, Mottengelee und Speiseaufzug für Schlüssel.' }, { id: 2, title: 'Hotel', content: 'Briefkastenpapiere und Raum 235 führen zum Boiler Room.' }, { id: 3, title: 'Boiler Room', content: 'Thermometer und Bug-Spray-Rohre helfen auf dem Weg zum Ausgang.' }], detailsHtml: `<h2>Kartenüberblick</h2><p>Diese Seite bündelt die drei bereitgestellten Karten für Level 5 Terror Hotel. Die Originalbilder stammen aus dem Escape The Backrooms Wiki auf Fandom und werden mit Quellenangabe gezeigt.</p><h2>Main Hall</h2><p>Drücke die Gemälde vom jüngsten zum ältesten, sammle Mottengelee und nutze den Speiseaufzug für die Schlüssel.</p><h2>Hotel und Boiler Room</h2><p>Die Briefkastenpapiere öffnen Raum 235 zum Boiler Room. Nutze dort Thermometer und Bug-Spray-Rohre; die echte Ausgangstür hat ein Exit-Schild.</p>` },
    { id: 10, title: 'The End Karten', addressBar: 'the-end-map', description: 'Übersichtskarte und durchschnittliche Kassetten-Spawn-Referenz für The End.', imageUrl: '/images/maps/The_End_Map.webp', imageAlt: 'The-End-Übersichtskarte.', mapImageUrl: '/images/maps/The_End_Map.webp', galleryImages: [{ src: '/images/maps/Averagetapespawn.webp', alt: 'The-End-Referenzkarte zu durchschnittlichen Kassetten-Spawns.', title: 'Durchschnittliche Kassetten-Spawns' }], category: 'Hauptstory', tags: ['The End', 'Kassetten', 'Computer', 'Feueralarm'], isHome: false, seo: { title: 'The End Karten: Übersicht & Kassetten-Spawn-Referenz - Escape the Backrooms', description: 'Finde Regale, Computer, Alarme, Tische und Kassetten-Referenzen.', keywords: 'The End Karte, Kassetten Spawns, Computer, Feueralarme' }, mapPoints: [{ id: 1, title: 'Computer', content: 'Kehre nach dem Sammeln der Kassetten hierher zurück.' }, { id: 2, title: 'Feueralarme', content: 'Zwei Alarme können den Scratcher ablenken.' }, { id: 3, title: 'Tische', content: 'Zwei Tische dienen als Verstecke.' }, { id: 4, title: 'Kassetten-Referenz', content: 'Zweites Bild: Beobachtungen aus sechs Spielen, keine Garantie.' }], detailsHtml: `<h2>Kartenüberblick</h2><p>Diese Seite bündelt die bereitgestellte Übersichtskarte und Kassetten-Spawn-Referenz für The End. Die Originalbilder stammen aus dem Escape The Backrooms Wiki auf Fandom und werden mit Quellenangabe gezeigt.</p><h2>Ziel</h2><p>Sammle Kassetten, kehre zum Computer zurück und benutze Tür, Leiter und Vent zu Level 94.</p><h2>Hinweis</h2><p>Das Übersichtsbild enthält einen Orb-Marker einer älteren Version. Die aktuelle Beschreibung nutzt den Tür-und-Leiter-Ausgang; Spawn-Farbpunkte sind nur Beobachtungen.</p>` }
]
