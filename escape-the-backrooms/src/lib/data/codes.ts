...
const entries: Record<Locale, readonly CodeSearchEntry[]> = {
  en: [
    ...
    { id: 'hub-password', title: 'M.E.G. Base Computer Password', code: 'itheardyou', description: 'Enter itheardyou at the M.E.G. Base computer, then run Gate.exe to open its gate.', type: 'fixed password computer' },
  ...
  de: [
    ...
    { id: 'hub-password', title: 'Passwort des M.E.G.-Basiscomputers', code: 'itheardyou', description: 'Gebt am Computer der M.E.G.-Basis itheardyou ein und startet anschließend Gate.exe, um das Tor zu öffnen.', type: 'festes Passwort Computer' },
  ...
  fr: [
    ...
    { id: 'hub-password', title: 'Mot de passe de l’ordinateur de la base M.E.G.', code: 'itheardyou', description: 'Saisissez itheardyou sur l’ordinateur de la base M.E.G., puis lancez Gate.exe pour ouvrir la grille.', type: 'mot de passe fixe ordinateur' },
  ...
  es: [
    ...
    { id: 'hub-password', title: 'Contraseña del ordenador de la base M.E.G.', code: 'itheardyou', description: 'Escribe itheardyou en el ordenador de la base M.E.G. y ejecuta Gate.exe para abrir la puerta.', type: 'contraseña fija ordenador' },
