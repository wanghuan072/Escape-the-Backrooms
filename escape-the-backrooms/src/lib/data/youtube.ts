...
const videoMetadata: Record<string, YouTubeVideoMetadata> = {
  ...
  VAWosLbO2fA: { updatedAt: '2026-09-04', durationSeconds: 280, chapters: [
    { startSeconds: 0, label: 'Find the Level 0.11 preparation route' },
    { startSeconds: 14, label: 'Raise shadow quality for the symbol clues' },
    { startSeconds: 20, label: 'Read the fixed Square-Circle-Arrow code' },
    { startSeconds: 51, label: 'Collect the chainsaw' },
    { startSeconds: 64, label: 'Cut the long wooden barrier' },
    { startSeconds: 85, label: 'Enter the damp Level 0.11 corridors' },
    { startSeconds: 91, label: 'Follow water, smoke, leeches, and arrows' },
    { startSeconds: 119, label: 'Avoid the fast Bacteria' },
    { startSeconds: 131, label: 'Locate the four timed levers' },
    { startSeconds: 195, label: 'Coordinate solo and co-op lever timing' },
    { startSeconds: 223, label: 'Cross the shutter and help teammates' },
  ...
  '03LJ0T8gIGQ': { updatedAt: '2026-09-04', durationSeconds: 529, chapters: [
    ...
    { startSeconds: 29, label: 'Collect the flashlight and supplies' },
    { startSeconds: 36, label: 'Read the numbered color containers' },
    { startSeconds: 47, label: 'Solve the mixed-color clue' },
    { startSeconds: 57, label: "Enter this run's randomized color code" },
    { startSeconds: 63, label: 'Enter Level 421' },
    { startSeconds: 74, label: 'Search all three floors for flower clues' },
    { startSeconds: 182, label: 'Use the three-floor layout' },
    { startSeconds: 223, label: 'Set the flower projectors' },
    { startSeconds: 308, label: 'Open the projector gate' },
    { startSeconds: 320, label: 'Enter the transporting ball pit' },
    { startSeconds: 335, label: 'Activate all four lighthouse switches' },
    { startSeconds: 400, label: 'Follow the white-ball trail and circle' },
    { startSeconds: 417, label: 'Start the four-hoop basketball puzzle' },
    { startSeconds: 459, label: 'Aim slightly below the hoop' },
    { startSeconds: 526, label: 'Unlock the exit door' },
  ] },
} as const
