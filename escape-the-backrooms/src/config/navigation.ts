...
export const navigationLabels = {
  en: { home: 'Home', levels: 'Levels', entities: 'Entities', maps: 'Maps & Keys', codes: 'Codes & Solutions', relatedGames: 'Related Games', navigate: 'Primary navigation', search: 'Search', quickLinks: 'Quick links', openMenu: 'Open navigation menu', closeMenu: 'Close navigation menu', currentLanguage: 'Current language', siteHome: 'Escape the Backrooms home' },
  de: { home: 'Startseite', levels: 'Level', entities: 'Entitäten', maps: 'Karten & Schlüssel', codes: 'Codes & Lösungen', relatedGames: 'Ähnliche Spiele', navigate: 'Hauptnavigation', search: 'Suchen', quickLinks: 'Schnellzugriff', openMenu: 'Navigationsmenü öffnen', closeMenu: 'Navigationsmenü schließen', currentLanguage: 'Aktuelle Sprache', siteHome: 'Startseite von Escape the Backrooms' },
  fr: { home: 'Accueil', levels: 'Niveaux', entities: 'Entités', maps: 'Cartes et clés', codes: 'Codes et solutions', relatedGames: 'Jeux similaires', navigate: 'Navigation principale', search: 'Rechercher', quickLinks: 'Accès rapides', openMenu: 'Ouvrir le menu de navigation', closeMenu: 'Fermer le menu de navigation', currentLanguage: 'Langue actuelle', siteHome: 'Accueil d’Escape the Backrooms' },
  es: { home: 'Inicio', levels: 'Niveles', entities: 'Entidades', maps: 'Mapas y llaves', codes: 'Códigos y soluciones', relatedGames: 'Juegos relacionados', navigate: 'Navegación principal', search: 'Buscar', quickLinks: 'Accesos rápidos', openMenu: 'Abrir el menú de navegación', closeMenu: 'Cerrar el menú de navegación', currentLanguage: 'Idioma actual', siteHome: 'Inicio de Escape the Backrooms' },
} as const
